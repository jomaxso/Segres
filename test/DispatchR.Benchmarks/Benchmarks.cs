...
public class Benchmarks
{
    ...
    //
    // [Benchmark]
    // public async Task PublishAsync_DispatchR() => await _dispatcher.PublishAsync(UserCreated, CancellationToken.None);
    //
    // [Benchmark]
    // public Task<int> Querysync_WithResponse_DispatchR() => _dispatcher.QueryAsync(GetUsers, CancellationToken.None);
    //
    // [Benchmark]
    // public async ValueTask StreamAsync_WithResponse_DispatchR()
    // {
    //     var stream = _dispatcher.StreamAsync(UserStream, CancellationToken.None);
    //
    ...
    //
    // [Benchmark]
    // public async ValueTask StreamAsync_WithResponse_MediatR()
    // {
