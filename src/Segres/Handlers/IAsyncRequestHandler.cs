    ...
    where TRequest : IRequest
{
    ...
    /// <summary>
    /// Asynchronously receive and handle a asyncRequest.
    /// </summary>
...
/// Defines a receiver (fire-and-forget) for a asyncRequest.
/// </summary>
/// <typeparam name="TRequest">The asyncRequest type witch implements <see cref="IAsyncRequestAsyncRequest{TResult}"/>.</typeparam>
