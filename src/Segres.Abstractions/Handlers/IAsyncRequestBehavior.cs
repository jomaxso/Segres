...
/// <summary>
/// The delegate for asynchronously intercepting a request with the <see cref="IAsyncRequestBehavior{TRequest,TResult}"/>. 
/// </summary>
/// <typeparam name="TResult">The type of the result.</typeparam>
public delegate ValueTask<TResult> AsyncRequestHandlerDelegate<TResult>(IRequest<TResult> request, CancellationToken cancellationToken);

/// <summary>
/// A interceptor for a request using the <see cref="ISender"/> to call the matching <see cref="IRequestHandler{TRequest}"/> or <see cref="IAsyncRequestHandler{TRequest}"/>
/// </summary>
    ...
    where TRequest : IRequest<TResult>
{
    ...
    public ValueTask<TResult> HandleAsync(AsyncRequestHandlerDelegate<TResult> next, TRequest request, CancellationToken cancellationToken);
}