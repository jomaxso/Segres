...
/// <typeparam name="TResponse">The type of the result specified from the <see cref="IRequest{TResult}"/> where the result result type implements <see cref="IResult{TSelf,T}"/>.</typeparam>
